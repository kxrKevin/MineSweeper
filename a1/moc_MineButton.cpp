...
void MineButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MineButton::leftClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MineButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MineButton::rightClicked)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MineButton::staticMetaObject = { {
    &QPushButton::staticMetaObject,
    qt_meta_stringdata_MineButton.data,
    qt_meta_data_MineButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
